...
import '../data_source/analytics/analytics_tracker.dart' as _i18;
import '../data_source/analytics/default_analytics_repository.dart' as _i21;
...
import '../data_source/analytics/trackers/std_out_analytics_tracker.dart'
    as _i16;
import '../data_source/crashlytics/crashlytics_repository.dart' as _i23;
import '../data_source/crashlytics/error_tracker.dart' as _i19;
import '../data_source/crashlytics/trackers/firebase_error_tracker.dart'
    as _i10;
import '../data_source/crashlytics/trackers/std_out_error_tracker.dart' as _i17;
import '../domain/analytics/analytics_repository.dart' as _i20;
import '../domain/analytics/event_tracker_use_case.dart' as _i25;
import '../domain/analytics/screen_tracker_use_case.dart' as _i26;
import '../domain/crashlytics/crashlytics_repository.dart' as _i22;
import '../domain/crashlytics/error_tracker_use_case.dart' as _i24;
import '../features/home/presentation/cubit/home_cubit.dart' as _i11;
import '../features/scanner/presentation/cubit/scanner_cubit.dart' as _i13;
import '../features/settings/presentation/cubit/settings_cubit.dart' as _i14;
import '../features/splash_screen/presentation/cubit/splash_cubit.dart' as _i15;
import 'modules/analytics.dart' as _i27;
import 'modules/crashlytics.dart' as _i28;
import 'modules/logger.dart' as _i29;
...
_i1.GetIt $initGetIt(
  ...
  gh.factory<_i8.FirebaseAnalyticsTracker>(() =>
      _i8.FirebaseAnalyticsTracker(analytics: get<_i7.FirebaseAnalytics>()));
  gh.factory<_i9.FirebaseCrashlytics>(
      () => crashlyticsModule.getFirebaseCrashlytics());
  gh.factory<_i10.FirebaseErrorTracker>(() =>
      _i10.FirebaseErrorTracker(crashlytics: get<_i9.FirebaseCrashlytics>()));
