...
class _$_RequestPermission implements _RequestPermission {
  const _$_RequestPermission(this.value);
  ...
  @override
  String toString() {
    return 'SettingsState.requestPermission(value: $value)';
  }
...
abstract class _RequestPermission
    implements SettingsState, SettingsBuilderState {
  const factory _RequestPermission(final bool value) = _$_RequestPermission;
